...
# project template directory, add inside TEMPLATES.DIRS list below
...
SECRET_KEY = '0u1k*@h^4#y0x)6x3tvhb1zuslnao7gfyp_xjrw*2q75mu*uu('
...
# universal static files directory
STATICFILES_DIRS = (
